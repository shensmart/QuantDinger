...
MCP_AGENT_TOOLS: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        id="mcp.get_market_events",
        category="research",
        label_zh="市场事件（榜单）",
        label_en="Market events",
        description_zh="按日期/类型/标的查询 A 股盘面事件：涨停/跌停/炸板池、连板天梯、龙虎榜、热榜、个股异动。",
        description_en="Query A-share board events by date/type/symbol: limit pools, ladder, dragon-tiger, hot list, anomalies.",
        route="/api/agent/v1/events",
        produces=("market_events",),
        risk_level="read",
        read_only=True,
        priority=76,
    ),
    ToolDefinition(
        id="mcp.get_limit_up_pool",
        category="research",
        label_zh="当日涨停池",
        label_en="Limit-up pool",
        description_zh="按交易日查询 A 股涨停/连板股票池，含封单额、连板数、涨停原因。",
        description_en="Limit-up and consecutive-board pool for a trade date with seal amount and reason.",
        route="/api/agent/v1/events/limit-up",
        produces=("limit_up_pool",),
        risk_level="read",
        read_only=True,
        priority=74,
    ),
    ToolDefinition(
        id="mcp.get_dragon_tiger",
        category="research",
        label_zh="龙虎榜",
        label_en="Dragon-tiger list",
        description_zh="按交易日查询龙虎榜全部/机构/游资榜单，含净买入额与上榜原因。",
        description_en="Dragon-tiger board for a trade date (all/org/hot money) with net buying and reason.",
        route="/api/agent/v1/events/dragon-tiger",
        produces=("dragon_tiger_list",),
        risk_level="read",
        read_only=True,
        priority=73,
    ),
    ToolDefinition(
        ...
        category="research",
        label_zh="同花顺热榜",
        label_en="THS hot list",
        description_zh="按交易日查询同花顺热股榜 Top30 与排名变化。",
        description_en="Tonghuashun hot-stock ranking and rank change for a trade date.",
        route="/api/agent/v1/events/hot-list",
        produces=("hot_list",),
        risk_level="read",
        read_only=True,
        priority=72,
